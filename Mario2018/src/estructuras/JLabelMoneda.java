...
public class JLabelMoneda extends JLabel {
	...
	public JLabelMoneda() {
		...
		try {
			...
			setIcon(new ImageIcon(JLabelMoneda.class.getResource("/imagenes/Moneda0.png").toURI().toURL()));
		} catch (Exception e) {
			System.err.println("Error en carga de recurso: Moneda0.png no encontrado");
			e.printStackTrace();
		}
		setVisible(true);
